...
export default function Page() {
  return (
    ...
    >
      ...
      >
        Vi startade den här biografen för att erbjuda invånare i Regna en sysselsättning under de dagar, veckor och
        månader med ihållande regn som ofta iaktas här. För att inte förstöra Regnas image som en deprimerande by gör vi
        i vårt filmutbud ett särskilt urval av gamla klassiker och nya releaser, samtliga med ett deprimerande tema! Vi
        gör inget anspråk på att förändra Regnas status quo, utan förser allmänheten med ett alternativt sätt att uppnå
        förödande depression. Kom till Bio Grådask och sörj livets slit och slask med oss!
      </Typography>
      ...
      >
        Vi har öppet enbart ifall av regn (eller vice versa?), vilket är för det mesta här i Regna. Med regn avses här
        en nederbörd på minst 0.2 mm/h, snö ej inkluderat.
      </Typography>
      ...
      >
        Vi tar emot fax på 35992-494Ar5. Nisse på kontoret håller på att installera datormaskin och vi hoppas inom kort
